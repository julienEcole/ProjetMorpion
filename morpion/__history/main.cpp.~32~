...
int main(){
	...
	do{
		...
		do{
			...
			cin >> colonne>>ligne;
			//coupValide=monMorpion.EnregistrerCoup(ligne,colonne,monMorpion.Pion());  //je ne trouve pas le pb emppechant de retenir le changement du pion; trouvé rajouter this devant pion
